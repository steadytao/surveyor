...
The same rule applies to the discovery slice described in [../commands/discovery.md](../commands/discovery.md).
The same rule applies to the audit slice described in [../commands/audit.md](../commands/audit.md).
