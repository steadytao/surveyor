...
This document defines the governance model for Surveyor.

Surveyor is intended to be a serious infrastructure and security project. Governance should therefore be clear, practical and proportionate to the current stage of the project.

## Purpose

The purpose of governance in Surveyor is to:
...
Surveyor currently uses a maintainer-led governance model.
...
Surveyor currently recognises the following roles:

### Core Maintainer(s)

The core maintainers are responsible for:
- defining and protecting project direction
- approving or declining architectural and product-boundary changes
...
- protecting the project's scope, safety posture and quality standards
...
Surveyor prefers clear maintainer decisions over vague consensus language.
...
- whether a contribution conflicts with the project's scope, safety model or standards
...
Security-sensitive decisions, including coordinated disclosure timing, remediation direction and advisory publication, are handled by the maintainers.
...
This document is the canonical governance document for Surveyor.
